...
int main(int argc, char *argv[])
{
    ...
    for (i = 0; i < 20; i++)
    {
        ...
        indice = fib_Search(arreglo, x[i], n);
    ...
    printf("Busqueda de fibonacci\t\t %d\t\t%.10e\t\t%.10e\t\t%.10e\n", n, sumaTiempos / 20, sumaCPU / 20, sumaES / 20);
    //Linea para script4.sh
    //printf("Busqueda de fibonacci\t\t %d\t\t%.10e\n", n, wtime1 - wtime0);
