...
# Compilacion
gcc ABB_thread.c tiempo.c -lpthread -o ABBT 
 ...
 do
 	...
 	do
       #Obtencion de tiempos de ejecucion para todas las x de una n
        ./ABBT "$a" "$b" < numeros10millones.txt  >> "./TiemposABBT.txt"
        done
        #Calculo del promedio de los tiempos obtenidos
      ./promedio 20 < TiemposABBT.txt >> salPromedioABBT.txt
      #Borrado del archivo para el siguiente calculo
       echo " "  > "./TiemposABBT.txt"
 done
