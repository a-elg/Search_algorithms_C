...
#Script para compilar el algoritmo de busqueda con ABB implementado con hilos en un ambiente LINUX
# Compilacion
gcc linear_threads.c tiempo.c -lpthread -o linear
 ...
 do
 	...
 	do
       #Obtencion de tiempos de ejecucion para todas las x de una n
        ./linear "$a" "$b" < numeros10millones.txt  >> "./TiemposLinear.txt"
        done
        #Calculo del promedio de los tiempos obtenidos
      ./promedio 20 < TiemposLinear.txt >> salPromedioLinear.txt
      #Borrado del archivo para el siguiente calculo
       echo " "  > "./TiemposLinear.txt"
 done
