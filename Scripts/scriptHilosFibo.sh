...
#Script para compilar el algoritmo de busqueda de fibonacci implementado con hilos en un ambiente LINUX
# Compilacion
gcc Fibonacci_search_thread.c tiempo.c -lpthread  -o Fibo
 ...
 do
 	...
 	do
       #Obtencion de tiempos de ejecucion para todas las x de una n
        ./Fibo "$a" "$b" < 10millones.txt  >> "./TiemposFibo2000000.txt"
        done
        #Calculo del promedio de los tiempos obtenidos
      ./promedio 20 < TiemposFibo2000000.txt >> salPromedioFibo2000000.txt
        #Borrado del archivo para el siguiente calculo
       echo " "  > "./TiemposFibo2000000.txt"
 done
